...
router.use('/', (request, response, next) => {
    ...
    respuesta += '<div class="Contenido "> <h1><FONT COLOR="blue"><center> Un animalito para ti! </center> </h1></FONT></h1></div>';
    //for (let i in comida) {
    respuesta +='  <div align="center"> <img  src = ' + animalitos[Math.floor(Math.random() * 4) + 1] + ' width = 400px height = 250px; alt = "Imagen Animalito"/> </div>';
   // } 
